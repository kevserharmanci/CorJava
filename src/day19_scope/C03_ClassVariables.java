package day19_scope;
         ...
         /*
        farklı bir class da calısırken herhangi bir class adını yazıp noktaya basarsak
        static adını yazdıgımız class dakı tum static class uyelerını gorebılır
        ve kullanabiliriz
        class dakı methodu calıstırır yukarıya bakmaz cunku methodu calıstırmak ıster oncekı degerlere bakmaz
        hıcbır ıslem yapmadan o class dakı variable ye bakar ..
