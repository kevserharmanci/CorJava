...
public class Fp05 {
    ...
    public static void ortalamasiEnYuksekKursunAdiniYazdir(List<Courses> list){
        ...
        /*
        String courseName = list.stream().max(Comparator.comparing(Courses::getAverageScore)).get().getCourseName(); //boylede olur
System.out.println("max "+courseName);
         */
    }
    ...
    public static List<Courses> ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(List<Courses> list, int x){
        ...
        //skip içine kac tanesını atlayacaksak onu yazarız
        // yani 3 verırsek once sıralar ve ılk uc kursu almaz en son en buyuk ortalamaya sahıp olanı yazar
    }
}